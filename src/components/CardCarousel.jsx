...
const ImageCardCarousel = ({ data }) => {
  ...
  const [wasPlayingBeforeHover, setWasPlayingBeforeHover] = useState(true);
  ...
  const handleMouseEnter = () => {
    setWasPlayingBeforeHover(isPlaying);
    setIsPlaying(false);
  };
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      >
        ...
        {/* Optional: Uncomment these for nav & play/pause controls */}
        {/* 
        <button
          onClick={prevSlide}
